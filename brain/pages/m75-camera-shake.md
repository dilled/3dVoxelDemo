...
- time: 2026-09-20T05:39:47
  kind: decision
  summary: "M14.3 tuning: CFG.input.shakeAmp 0.22 → 0.18 m (subtle, no nausea); decay/cap/impulse unchanged to keep the cap-hold margin; Key N impulse verified monotone to exactly 0 in ~0.35 s, camera exactly on pose"
