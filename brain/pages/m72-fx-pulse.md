...
updated: "2026-09-15T21:30:51"
---

<!-- compiled_truth -->
## Decided

- `FX` is the new FX system (M7.2; later arcs M7.3, flash M7.4, shake M7.5). Registered in the systems registry between PARTS and HUD; exposed as `window.SIM.FX`. `FX.pulse(origin, radius, color)` is the public API (seams: M9.4 plaza pulse, M13.2 data pulse, dev trigger).
